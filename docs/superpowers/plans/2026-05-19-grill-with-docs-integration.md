...
- [x] **Step 1: Phase 0 메타 룰 카운트 수정**

찾기: `메타 룰 6개 마커 존재 (\`## §1\` ~ \`## §6\`)`
교체: `메타 룰 8개 마커 존재 (\`## §1\` ~ \`## §8\`)`

- [x] **Step 2: Phase 2 설명 및 파일 목록 수정**
...
- [x] **Step 3: Phase 3 검증 카운트 + CONTEXT.md 항목 추가**
...
- [x] **Step 3: Closeout C-1 context_paths에 CONTEXT.md 추가**
...
- [x] **Step 1: Phase 1 context_paths에 CONTEXT.md 추가**
...
- [x] **Step 2: Phase 4 입력 파일 목록에 CONTEXT.md 추가**
...
- [x] **Step 2: verify-setup.sh 전체 실행**
...
- [x] **Step 1: 필수 플러그인 표에 mattpocock/skills 추가**
...
- [x] **Step 2: 구조 트리에 CONTEXT.md.tpl 추가**
...
- [x] **Step 3: 시나리오 2 Phase R 설명에 grill-with-docs 추가**
...
- [x] **Step 2: CLAUDE.md 줄 수 확인 (≤200줄)**
...
- [x] **Step 1: verify-setup.sh 전체 실행**
...
- [x] **Step 3: grill-with-docs 스킬 설치 확인 (doctor.sh 실행)**
